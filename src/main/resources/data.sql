...
create table categories (
    category_name_id varchar(50) not null primary key
);
...
create table products (
                          ...
                          constraint fk_products_categories foreign key(category_name_id) references categories(category_name_id)
                              ON UPDATE CASCADE
);
...
INSERT INTO authorities (authority_id,authority,username) VALUES (
...
INSERT INTO products (product_id,product_name,product_description,product_image_url,product_price,category_name_id) VALUES (
                                                                                                                               NEXT VALUE FOR MYSEQ,
